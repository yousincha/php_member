<?php
	...
	if (isset($_SESSION["tel"])) $usertel = $_SESSION["tel"];
    else $usertel = "";
?>		
        <div id="top">
            <h3>
                <a href="index.php">PHP 프로그래밍 (차유신)</a>
            </h3>
            <ul id="top_menu">  
<?php
    if(!$userid) {
...
<?php
                ...
                $logged = $username."(".$userid.")님[Level:".$userlevel.", Point:".$userpoint.", tel : ]".$usertel;
?>
                <li><?=$logged?> </li>
                <li> | </li>
...
?>
                <li> | </li>
                <li><a href="admin.php">관리자_차유신(15장)</a></li>
<?php
    }
?>
            </ul>
