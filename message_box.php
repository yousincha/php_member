...
<?php
	...
	if ($mode=="send")
		$sql = "select * from message where send_id='$userid' and gubun is null order by num desc";
	else
		$sql = "select * from message where rv_id='$userid' and gubun is null order by num desc";
